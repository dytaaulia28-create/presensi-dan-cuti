		...
		<ion-content :fullscreen="true">
			<div class="page-pad" v-if="p">
				<div class="prof card text-center">
					...
					<p class="muted" style="margin:0">{{p.position || 'Karyawan'}}</p>
				</div>

				<div class="card" style="margin-top:12px">
					<div class="row"><span class="muted">NIK</span><strong>{{p.nik}}</strong></div>
					<div class="row"><span class="muted">Divisi</span><strong>{{p.division || '-'}}</strong></div>
...
.avatar {
	...
	justify-content: center; font-family: "Outfit"; font-size: 1.8rem; font-weight: 700;
}
