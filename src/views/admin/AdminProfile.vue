<template>
	<ion-page>
		<ion-header class="ion-no-border">
			<ion-toolbar>
				<ion-title>Profil Admin</ion-title>
			</ion-toolbar>
		</ion-header>
		<ion-content :fullscreen="true">
			<div class="page-pad" v-if="p">
				<div class="prof card text-center">
					...
					<p class="muted" style="margin:0">Administrator</p>
				</div>

				<div class="card" style="margin-top:12px">
					<div class="row"><span class="muted">NIK</span><strong>{{p.nik}}</strong></div>
					<div class="row"><span class="muted">Divisi</span><strong>{{p.division || 'IT/Admin'}}</strong></div>
